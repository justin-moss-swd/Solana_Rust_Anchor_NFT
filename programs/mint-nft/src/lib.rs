...
pub mod mint_nft {
    ...
    pub fn mint(
        ...
        /*
         *  Following invokes allow Solana Explorer and Wallets to link and pull metadata
         */
...
pub struct MintNft<'info> {
    ...
    // Does not need check because it is not an unchecked account
    #[account(mut)]
    pub mint: Signer<'info>,
    
    /// CHECK: Create with Anchor
    #[account(mut)]
